...
public class ReviewDao {
   ...
   public List<Map<String, Object>> allReview() {
	      String sql = "select a.REVIEW_NO, b.STO_NAME, a.STO_NO, a.MEM_ID, a.RVW_SCORE, a.RVW_REMARK  from review a, store b where a.STO_NO = b.STO_NO order by a.review_no desc";
