...
//         String id = (String) MemberService.loginMap.get("MEM_ID");
//         String pw = (String) MemberService.loginMap.get("MEM_PASS");
      String id = (String) Controller.sessionStorage.get("Ui_id");
...
//      String id = (String) MemberService.singMap.get("MEM_ID");
...
//      String id = (String) MemberService.singMap.get("MEM_ID");
//      String pw = (String) MemberService.singMap.get("MEM_PASSWORD");
      String id = (String) Controller.sessionStorage.get("sign_id");
...
//      String id = (String) MemberService.singMap.get("MEM_ID");
//      String pw = (String) MemberService.singMap.get("MEM_PASSWORD");
//      String nm = (String) MemberService.singMap.get("MEM_NAME");
      String id = (String) Controller.sessionStorage.get("sign_id");
      String pw = (String) Controller.sessionStorage.get("sign_pw");
